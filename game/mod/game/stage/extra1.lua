...
stage.group.New('attr_select', {}, "Extra1", false)
local Exstage1 = stage.group.AddStage("Extra1", "Extra1@1", false)
...
local Summary = stage.group.AddStage("Extra1", "Extra1@2", false)
